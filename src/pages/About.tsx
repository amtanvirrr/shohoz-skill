    ...
    <div className="py-16 lg:py-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto max-w-3xl">
          <h1 className="text-4xl font-bold text-foreground">About ShikhonHub</h1>
          <div className="mt-8 space-y-6 text-muted-foreground leading-relaxed">
            <p>
              ShikhonHub হলো বাংলাদেশের একটি আধুনিক শিক্ষা প্ল্যাটফর্ম যেখানে আপনি পাবেন মানসম্পন্ন অনলাইন কোর্স এবং হ্যান্ডপিকড বই।
            ...
            <h2 className="!mt-10 text-2xl font-bold text-foreground">কেন ShikhonHub?</h2>

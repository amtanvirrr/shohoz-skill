...
const AdminCourses = () => {
  ...
  const [form, setForm] = useState({ title: "", instructor: "", price: "", original_price: "", image_url: "", description: "", category: "", duration: "", is_published: true });
  ...
  const resetForm = () => {
    setForm({ title: "", instructor: "", price: "", original_price: "", image_url: "", description: "", category: "", duration: "", is_published: true });
    setEditing(null);
  };
        ...
        <div className="mt-6 overflow-x-auto">
          <table className="w-full text-left text-sm">
            <thead className="border-b border-border text-muted-foreground">
              <tr><th className="pb-3 pr-4">Title</th><th className="pb-3 pr-4">Instructor</th><th className="pb-3 pr-4">Price</th><th className="pb-3 pr-4">Status</th><th className="pb-3">Actions</th></tr>
            </thead>
            <tbody>
              {courses.map((course) => (
                <tr key={course.id} className="border-b border-border">
                  <td className="py-3 pr-4 font-medium text-foreground">{course.title}</td>

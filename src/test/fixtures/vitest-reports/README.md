...
| `partial-truncation-attach.json` | Structured walker found 1 mismatch; raw text contains that one plus 2 extras for the same source | Recovered extras must ATTACH to the originating failure (real test name), not bucket under "(unattributed)". |
